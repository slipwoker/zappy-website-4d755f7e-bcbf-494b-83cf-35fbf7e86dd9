document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    const ERROR_MESSAGE_CLASS = 'field__error-message';
    ...
    function showFieldError(field, message) {
      const wrapper = field.closest('.form-group, .field, [data-field]') || field.parentElement;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4d755f7e-bcbf-494b-83cf-35fbf7e86dd9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4d755f7e-bcbf-494b-83cf-35fbf7e86dd9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4d755f7e-bcbf-494b-83cf-35fbf7e86dd9';
